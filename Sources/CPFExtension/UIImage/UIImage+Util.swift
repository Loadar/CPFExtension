...
public extension UIImage {
    /// 图像渲染
    class func cpf_render(size: CGSize, opaque: Bool = false, scale: CGFloat? = nil, _ renderHandler: () -> Void) -> UIImage? {
...
public extension UIImage {
    ...
    ///   - size: 指定图像大小，默认(1, 1)
    /// - Returns: 结果图像
    class func cpf_image(with color: UIColor, size: CGSize? = nil) -> UIImage? {
    ...
    class func cpf_image(
        with color: UIColor,
        size: CGSize,
        border: (CGFloat, UIColor)? = nil,
        corner radius: CGFloat? = nil
    ) -> UIImage? {
        let layer = CALayer()
    ...
    /// - Returns: 结果图像
    func cpf_tint(_ color: UIColor) -> UIImage? {
...
public extension UIImage {
    ...
    /// - Returns: 结果图片
    func cpf_resize(to size: CGSize, opaque: Bool = false) -> UIImage? {
        ...
        let newSize = imageSize.cpf.scale(toFit: size)
    ...
    func cpf_resize(with scale: CGFloat, opaque: Bool = false) -> UIImage? {
...
public extension UIImage {
    /// 旋转图片一定的弧度
    func cpf_rotate(_ radian: CGFloat) -> UIImage? {
